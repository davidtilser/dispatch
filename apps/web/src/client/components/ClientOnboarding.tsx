      ...
      <div className="text-center max-w-2xl mx-auto mb-10">
        ...
        >
          ...
          <p className="mt-3 text-xs sm:text-sm text-[#d8ceb2] leading-relaxed">
            Dispatch bridges clients with local SMBs. Choose a category below to discover nearby providers, explore sample availability, or join a demo waitlist.
          </p>
        </motion.div>
      </div>
      ...
      >
        {CATEGORIES.map((cat: CategoryInfo) => (
          <motion.button
            ...
            className="text-left cursor-pointer rounded-2xl p-5 bg-[#0d1c42] hover:bg-[#0d1c42]/90 border border-[#22396f] hover:border-[#fcf1d0]/50 shadow-md transition-all flex flex-col justify-between"
          >
            <div>
